...
int main(int argc, char* argv[]){
		...
		std::ifstream cfg_session;
 		...
 		int el, Ndata;
		double fc_l, H_l, gamma_l, a1, a2, a3, asym, inc;
		VectorXd range, V, x_l, model;
		...
		std::cout << "  2. Reading the file with the parameters for the build_lorentzian::build_l_mode_a1a2a3() function..." << std::endl;
...
void usage(int argc, char* argv[]){
		...
		if( argc < 2){
			std::cout << " This program is mostly a debug program for the function build_l_mode_a1a2a3() inside the build_lorentzian.cpp files (the core function making Lorentzian models)" << std::endl;
