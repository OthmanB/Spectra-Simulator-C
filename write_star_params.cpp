...
void write_star_params_act_asym(VectorXd spec_params, MatrixXd mode_params, MatrixXd noise_params, std::string file_out, std::string identifier){
	...
	if(outfile.is_open()){
		...
		precision_params << 1, 10, 10, 10, 10, 8, 8, 8, 2, 8, 1;
        ...
        //std::cout << "                     - getting in the loop for params..." << std::endl;
        ...
        //std::cout << "                     - exited the loop for params..." << std::endl;
        ...
        //std::cout << "                     - getting in the loop for noise..." << std::endl;
		...
		outfile.close();
       // std::cout << "                     - exited in the loop for noise..." << std::endl;
...
void write_star_mode_params_act_asym(MatrixXd mode_params, std::string file_out){
	...
	Nchars << 5, 15, 15, 15, 10, 16, 16, 16, 14, 16, 10;
	precision << 1, 2, 4, 4, 4, 8, 8, 8, 2, 8, 1;
